...
export default function SecondSection() {
    ...
    return (
        <div >
            ...
            <Grid container spacing={10}  style={{ backgroundColor:'#769ABC'}}>
                <Grid item xs={10} sm={10} md={10}  lg={10} style={{margin:'10px auto 100px auto', textAlign:'center'}} >
                    ...
                    <iframe title="Ultima reunión de Jovenes" width={'100%'} height={600} src="https://www.youtube.com/embed/0NUYR7j5FXU" frameBorder={0} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
