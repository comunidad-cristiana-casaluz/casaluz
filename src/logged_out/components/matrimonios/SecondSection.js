...
export default function SecondSection() {
    ...
    return (
        <div >
            ...
            <Grid container spacing={5}  style={{ backgroundColor:'#EAF1FD'}}>
                <Grid item xs={10} sm={10} md={10}  lg={10}  style={{margin:'10px auto 80px auto', textAlign:'center'}} >
                    <div style={{padding:"50px 40px"}}>
                        <Typography style={{ margin:'auto'}} variant="h2" paragraph  gutterBottom >
                            NUESTRAS REUNIONES
                        </Typography>
                    ...
                    <iframe  title="Ultima reunión de Matrimonios" width={'100%'} height={600} src="https://www.youtube.com/embed/0NUYR7j5FXU" frameBorder={0} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />     
                </Grid>
            </Grid>
        </div>
    )
